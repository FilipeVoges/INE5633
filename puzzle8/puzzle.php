...
$element1 = new Piece(NULL, 1, new Position(0, 0));
$element2 = new Piece(NULL, 2, new Position(0, 1));
$element3 = new Piece(NULL, 3, new Position(0, 2));
$element4 = new Piece(NULL, 4, new Position(1, 0));
$element5 = new Piece(NULL, 5, new Position(1, 1));
$element6 = new Piece(NULL, 6, new Position(1, 2));
$element7 = new Piece(NULL, 7, new Position(2, 0));
$element8 = new Piece(NULL, 8, new Position(2, 1));
...
$initialBoard->set('emptyPiece', $element5);
